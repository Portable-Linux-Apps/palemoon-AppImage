...
[![GitHub Downloads](https://img.shields.io/github/downloads/Portable-Linux-Apps/palemoon-AppImage/total?logo=github&label=GitHub%20Downloads)](https://github.com/Portable-Linux-Apps/palemoon-AppImage/releases/latest)
[![CI Build Status](https://github.com//Portable-Linux-Apps/palemoon-AppImage/actions/workflows/blank.yml/badge.svg)](https://github.com/Portable-Linux-Apps/palemoon-AppImage/releases/latest)

This repo takes the [official palemoon binaries](https://www.palemoon.org/download.shtml) and turns them into an AppImage. 
